...
\begin{frame}{PET reconstruction as a linear inverse problem}{Positron Emission Tomography (PET) imaging}
    \begin{center} $\vcenter{\hbox{\includegraphics[scale=0.25]{simu_pt.jpg}}}
= \text{Poisson}\left( A \cdot
\vcenter{\hbox{\includegraphics[scale=0.5, trim = 20 20 20 20, clip]{gt_web_after_scaling.png}}} + b
\right) $\end{center}
\vspace{0.5cm}
    \begin{itemize}
...
\begin{frame}{PET reconstruction methods}{Positron Emission Tomography (PET) imaging}
    \begin{figure}
        \begin{tikzpicture}
            ...
            \node (sino) {\includegraphics[scale=0.27]{simu_pt.jpg}};
            \node (sino_label) [below=of sino, yshift=0.5cm] {Sinogramm};

            \node (brain_fbp) [right=of sino, xshift=1cm, yshift=1.5cm] {\includegraphics[scale=0.25, trim = 35 35 35 35, clip]{prompt_fbp.png}};
            \node (brain_mlem) [right=of sino, xshift=1cm, yshift=-1.5cm] {\includegraphics[scale=0.25, trim = 35 35 35 35, clip]{prompt_mlem.png}};
...
\begin{frame}{Methodology}{Noise2Noise for PET reconstruction/denoising}
    ...
    \begin{figure}
        \begin{tikzpicture}
            \tiny
            \node (full_sino) {\includegraphics[scale=0.15]{image_to_image/prompt.png}};
            \node [right=0.1cm of full_sino] {Sampling};
            \node (bin0) [right=0.45cm of full_sino, yshift=-1.5cm] {\includegraphics[scale=0.15]{image_to_image/prompt1.png}};
            \node (bin1) [right=0.45cm of full_sino, yshift=1.5cm] {\includegraphics[scale=0.15]{image_to_image/prompt2.png}};

            \node (brain_0) [right=0.45cm of bin0] {\includegraphics[scale=0.15]{image_to_image/mlem1.png}};
            \node (brain_1) [right=0.45cm of bin1] {\includegraphics[scale=0.15]{image_to_image/mlem2.png}};

            \node (recon_bin_0) [right=0.45cm of brain_0] {\includegraphics[scale=0.15]{image_to_image/mlem1_denoised.png}};
            \node (recon_bin_1) [right=0.45cm of brain_1] {\includegraphics[scale=0.15]{image_to_image/mlem2_denoised.png}};
            \node (recon_full) [right=0.45cm of recon_bin_1, yshift=-1.5cm] {\includegraphics[scale=0.15]{image_to_image/mlem_denoised.png}};
...
\begin{frame}{Towards PnP/RED...}{Conclusion and Perspectives}
    Gradient Step Denoiser : $D_\theta = I - \nabla \left\| I - N_\theta \right\|^2$ \cite{hureault2021}
    \begin{figure}
        \centering
        \begin{subfigure}[b]{0.32\textwidth}
            \centering
        ...
        \begin{subfigure}[b]{0.32\textwidth}
            ...
            \label{fig:res3}
        \end{subfigure}
        \caption{Noise2Noise results with data consistency ($\mathcal{L}\CI$)}
